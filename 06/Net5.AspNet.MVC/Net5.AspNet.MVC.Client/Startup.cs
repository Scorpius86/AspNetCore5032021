...
namespace Net5.AspNet.MVC.Client
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            var scoopeFactory = app.ApplicationServices.GetRequiredService<IServiceProvider>();
            var scoope = scoopeFactory.CreateScope();
            SeeData.Initialize(scoope.ServiceProvider);
